...
```{r}
#| echo: false
random_pages <- readRDS(here("data", "01_wikipedia", "pages.rds"))
```
...
# Save results
saveRDS(all_links, file = here("data", "01_wikipedia", "links.rds"))
```
...
#| echo: false
# Read results
all_links <- readRDS(file = here("data", "01_wikipedia", "links.rds"))
```
...
ggsave(here("posts", "images", "01_wikipedia.jpg"), gg,
