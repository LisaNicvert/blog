...
```{r}
#| echo: false
random_pages <- readRDS(here("wikipedia", "data", "pages.rds"))
```
...
# Save results
saveRDS(all_links, file = here("wikipedia", "data", "links.rds"))
```
...
#| echo: false
# Read results
all_links <- readRDS(file = here("wikipedia", "data", "links.rds"))
```
...
ggsave(here("wikipedia", "images", "wikipedia.jpg"), gg,
