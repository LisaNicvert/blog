...
saveRDS(random_pages, file = file.path("wikipedia", "data", "pages.rds"))
```

```{r}
#| echo: false
random_pages <- readRDS(file.path("wikipedia", "data", "pages.rds"))
```
...
# Save results
saveRDS(all_links, file = file.path("wikipedia", "data", "links.rds"))
```
...
#| echo: false
# Read results
all_links <- readRDS(file = file.path("wikipedia", "data", "links.rds"))
```
...
ggsave(file.path("wikipedia", "images", "wikipedia.jpg"), gg,
